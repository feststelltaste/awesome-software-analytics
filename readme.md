...
- [Oliver Tigges, Philip Haußleiter: Software Dependency Analysis with Graph Databases (2015)](https://www.youtube.com/watch?v=LpmWgCOP4kQ) - software libraries dependency analysis by using a graph database
