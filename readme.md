...
- [Oliver Tigges, Philip Haußleiter: Software Dependency Analysis with Graph Databases](https://www.youtube.com/watch?v=LpmWgCOP4kQ) - software libaries dependency analysis by using a graph database
