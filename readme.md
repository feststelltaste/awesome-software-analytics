...
- [Margaret-Anne Storey: Lies, Damned Lies and Software Analytics](https://www.youtube.com/watch?v=Ujm4G7ayRQQ) - an overview of the history and goals of Software Analytics. I especially like the part where Margaret talks about the risks of Software Analytics like data quality issues, missing trustworthiness of results, and ethical concerns.
